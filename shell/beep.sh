#!/bin/bash
# Scritp taken from Dicas-L -> I didn't wrote this, but I wanted to keep it
# stored somewhere.
# The original post can be found here:
# http://www.dicas-l.com.br/arquivo/usando_o_comando_beep.php
# (Brazilian Portuguese)
# Check if you have pcspkr kernel module loaded

beep || ( echo "Comando beep nao encontrado" && exit 1 )
